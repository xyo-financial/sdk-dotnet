...
inputSpec: /Users/hadi/dev/start-ups/xyo/sdks/specs/openapi.yml
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{AAF0166D-91C1-493F-9034-86F903F6FBBB}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IEnrichmentApi>();
            IEnrichTransactionApiResponse apiResponse = await api.EnrichTransactionAsync("todo");
            EnrichmentResponse? model = apiResponse.Ok();
        }
