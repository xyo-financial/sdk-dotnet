...
namespace Xyo.Generated.Client
{
    ...
    /// </summary>
    /// <typeparam name="TType"></typeparam>
    public interface IHttpStatusCode3XX<TType> : IApiResponse
    {
        /// <summary>
        /// Deserializes the response if the response is HttpStatusCode3XX
        /// </summary>
        /// <returns></returns>
        TType HttpStatusCode3XX();

        /// <summary>
        /// Returns true if the response is HttpStatusCode3XX and the deserialized response is not null
        /// </summary>
        /// <param name="result"></param>
        /// <returns></returns>
        bool TryHttpStatusCode3XX([NotNullWhen(true)]out TType? result);
    }
    ...
    /// </summary>
    /// <typeparam name="TType"></typeparam>
    public interface IHttpStatusCode5XX<TType> : IApiResponse
    {
        /// <summary>
        /// Deserializes the response if the response is HttpStatusCode5XX
        /// </summary>
        /// <returns></returns>
        TType HttpStatusCode5XX();

        /// <summary>
        /// Returns true if the response is HttpStatusCode5XX and the deserialized response is not null
        /// </summary>
        /// <param name="result"></param>
        /// <returns></returns>
        bool TryHttpStatusCode5XX([NotNullWhen(true)]out TType? result);
    }
